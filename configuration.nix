...

{
  ...
  # Ativar suporte a hardware OpenGL
  hardware.opengl.enable = true;

  # Usar os drivers Mesa para AMD
  hardware.opengl.package = pkgs.mesa_drivers;

  # Configuração do X server para usar o driver amdgpu
  services.xserver.videoDrivers = [ "amdgpu" ];

  # Ativar o firmware necessário para GPUs AMD
